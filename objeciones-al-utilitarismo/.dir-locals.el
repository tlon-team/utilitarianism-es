...
((markdown-mode . ((jinx-languages . "es")
		   ...
		   (eval . (add-hook 'after-save-hook #'tlon-babel-autofix-all nil t))
		   ;; (eval . (add-hook 'after-save-hook #'tlon-babel-check-file-title-match nil t))
                   ;; (eval . (add-hook 'after-save-hook #'tlon-babel-yaml-reorder-front-matter nil t))
		   (eval . (add-hook 'after-save-hook #'tlon-babel-highlight-url-correspondences nil t))
		   (eval . (add-hook 'before-save-hook #'tlon-babel-md-sort-related-entries nil t)))))
