...
La respuesta natural a las preocupaciones por la incertidumbre radical es pasar al [consecuencialismo de expectativas](tipos-de-utilitarismo#utilitarismo-de-expectativas-y-utilitarismo-objetivo): promover el valor esperado en lugar del valor real. Además, en cuanto [teoría multinivel](/tipos-de-utilitarismo#utilitarismo-multinivel-y-utilitarismo-de-un-solo-nivel), el utilitarismo permite que promovamos mejor el valor esperado [recurriendo a heurísticas más que a cálculos explícitos](/utilitarismo-y-ética-práctica/#respetar-las-normas-morales-de-sentido-común) de las probabilidades de todos y cada uno de los posibles resultados. Así que si salvar vidas a corto plazo suele tener un valor esperado positivo, eso bastaría para rechazar la objeción de la incertidumbre radical.
